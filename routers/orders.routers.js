...
const { getOrderSchema, createOrderSchema, updateOrderSchema, addItemSchema } = require("../schemas/ordersDTO");
...
routerOrders.post("/add-item", validatorHandler(addItemSchema, "body"), async (req, res, next) => {
    const body = req.body;
